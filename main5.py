...
io = IO(__file__, 'train5',inputScript='main4',inputRunName='train4',inputTag=1)
...
model.fit(X_train,y_train,epochs=100,validation_split=.2,callbacks=my_callbacks,verbose=2)
...
model.fit(X_train,y_train,validation_split=.2,callbacks=my_callbacks,epochs=500,verbose=2)
